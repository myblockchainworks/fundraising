		...
		<div class="container" style="padding-top: 80px;">
		    ...
		    <div class="col-md-12">
		    	<div class="box" style="min-height: 190px;">
					...
					<h4><b>${job.title}</b></h4>
					<p>${job.description}</p>
					<p style="float:left;"><b>Fund Required: ${job.fundRequired} (FYN)</b></p>
					<p style="float:right;">Achieved Fund: ${job.achievedAmount } (FYN)</p>
					<br>
		        	 ...
		        	 <table class="table table-bordered table-hover" id="products">
						...
						<c:forEach items="${investments}" var="investment">
							...
							<tr>
								...
								<td class="forceRefundAmount${count}"><script>showForceRefundValueButton('<c:out value='${investment.investmentid}'/>','<c:out value='${job.referenceNumber}'/>','<c:out value='${investment.refundstatus}'/>','<c:out value='${job.status}'/>', 'forceRefundAmount' + '<c:out value='${count}'/>');</script></td>
								<td class="refundAmount${count}"><script>showRefundValue('<c:out value='${investment.refundstatus}'/>','<c:out value='${investment.refundamount}'/>', 'refundAmount' + '<c:out value='${count}'/>');</script></td>
							</tr>
						</c:forEach>
					</table>
