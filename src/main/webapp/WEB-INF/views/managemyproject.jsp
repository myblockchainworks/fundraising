	...
	<div id="wrapper">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav side-nav">
				<li class="active"><a href="vendorhome"><i class="fa fa-tasks" aria-hidden="true"></i>
						My projects</a></li>

				<li><a href="vendorprofile"><i class="fa fa-user" aria-hidden="true"></i>
						My profile</a></li>
		        	 ...
		        	 <table class="table table-bordered table-hover" id="products">
						...
						<c:forEach items="${milestones}" var="milestone">
							...
							<tr>
								...
								<td class="showButton${count}"><script>showMilestoneButton('<c:out value='${milestone.status}'/>', '<c:out value='${referenceNumber}'/>', '<c:out value='${milestone.currentIndex}'/>', 'showButton' + '<c:out value='${count}'/>');</script></td>
							</tr>
						</c:forEach>
					</table>
