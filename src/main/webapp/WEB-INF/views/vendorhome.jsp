				...
				<c:set var="count" value="${count + 1}" scope="page"/>
				 <div class="col-md-3">
			        <div class="box">
						...
						<h4><b>${job.title}</b></h4>
						<p>${job.description}</p>
						<p><b>Project Value: ${job.fundRequired} (ETH)</b></p>
						<br>
						<span class="showButton${count }"><script>showVendorButton('showButton' + '<c:out value='${count}'/>', '<c:out value='${job.referenceNumber}'/>');</script> </span>
					</div>
			    </div>
			</c:forEach>
		</div>
