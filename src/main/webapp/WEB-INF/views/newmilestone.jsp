				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="breadcrumb">
							...
							<form class="form-horizontal" role="form" action="addNewMilestone" method="post">
								
								<div class="panel panel-info" >
									<div class="panel-heading">
				                     	<div class="panel-title"><h4>Add New Milestone <a href="manageproject?referenceNumber=${referenceNumber}" class="buttontype" style="float:right;margin-top: -5px"> Back</a> </h4> </div>
				                 	</div>
			                 	</div>
								...
								<div class="form-group">
									<div class="col-sm-12">
										<input type="hidden" name="referenceNumber" id="referenceNumber" value="${referenceNumber}"></input>
										<input type="hidden" name="vendor" id="vendor" value="${vendor}"></input>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<label>Payment Percentage</label> <input type="text" id="paymentPercentage" name="paymentPercentage" placeholder="e.g., 20" class="form-control" required>
									</div>
									<div class='col-sm-6'>
										<label>Expected Completion Date</label>
										<div class='input-group date' id='datetimepicker1'>
											<input type="date" id="completionDate" name="completionDate" class="form-control" required></input>
										</div>
									</div>
